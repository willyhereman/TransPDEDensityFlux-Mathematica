(* Adjustments by Hereman 09/18/2003 *)
(* Marked by date and name *)
(* Hereman *)
(*****************************************************************************)
(*                                                                           *)
...
{i,choice,lenpage},
(* 09/18/2003 Hereman: tell Paul, take out to save space *)
(* cls; *)
...
(* 09/18/2003 Hereman: tell Paul, adjust for version 4.0 and 5.0 *)
If[$VersionNumber <= 5.,
...
(* 09/18/2003 Hereman: end change for different versions *)
           derivConstCtr++,
...
(* 09/18/2003 Hereman: tell Paul: print statements on separate lines *)
