...
(* Liouville Equation w/ weighted parameter *)
eq[1][x,t] = D[D[u[1][x,t],t],x] - alpha*Exp[u[1][x,t]];

noeqs = 1;
name = "Liouville Equation w/ weighted parameter";
parameters = {};
weightpars = {alpha};
