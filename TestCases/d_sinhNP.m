(* Data file d_sinhNP.m *)

(* Hyperbolic Sine-Gordon Equation *)
eq[1][x,t] = D[D[u[1][x,t],t],x] - Sinh[u[1][x,t]];

noeqs = 1;
name = "Hyperbolic Sine-Gordon Equation";
parameters = {};
weightpars = {};
